...
public class BulletGunAlien extends BulletGun {
   ...
   public void pursueObject() {
      ...
      if(this.pursueVector2 == null) {
         ...
         MyVector2.tmp2.set(this.getWorldShootXY());
         MyVector2.tmp.set(this.pursueVector2).add(this.pursueOffset);
         Vector2[] var3 = this.directionsVel;
         int var4 = var3.length;

         for(int var5 = 0; var5 < var4; ++var5) {
            Vector2 var6 = var3[var5];
            Enemy.getPursueVel(MyVector2.tmp2, MyVector2.tmp, this.velBullet, var6);
         }
      }
