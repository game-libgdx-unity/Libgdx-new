...
import com.doodlegames.air.force.game.path.EnemyMutiMove.IPathInfoSet;
...
public class PathInfoLoader
	...
	public static EnemyMutiMove.IPathInfoSet getPathInfoSetByHandle(
		...
		for (int i2 = 0; i2 < pathInfoSetData.infos.size; i2++) {

			if (pathInfoSetData.infos.get(i2) instanceof EnemyMutiMove.MutiPathInfo) {

				((EnemyMutiMove.MutiPathInfo) pathInfoSetData.infos.get(i2))
	...
	@Override
	public IPathInfoSet load(AssetManager assetManager, String fileName,
			FileHandle file, PathInfoParameter parameter) {
		// TODO Auto-generated method stub
		return getPathInfoSetByHandle(this.resolve(fileName)); 
	}
