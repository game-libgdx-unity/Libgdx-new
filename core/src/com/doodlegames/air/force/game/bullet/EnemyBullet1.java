...
public class EnemyBullet1 extends Bullet {
   ...
   private void set(GameObject var1, float var2, float var3, float var4, float var5, Animation var6) {
      super.reset(var1, var2, var3, (float)RegionUtilFunctions.getRegionWidth(var6) / 1.0F, (float)RegionUtilFunctions.getRegionHeight(var6) / 1.0F, MyVector2.tmp.set(var4, var5));
