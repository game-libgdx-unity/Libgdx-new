   ...
   public void updateShooting(float var1) {
      ...
      if(this.clockShooting.isFired() && var2 < 1) {
         ...
         for(int var5 = 0; var5 < var4; ++var5) {
            ...
            Enemy.bullets.add(EnemyBullet1.alienBulletGen.getABullet(this, this.world, this.bounds.x + var6.x, this.bounds.y + var6.y, MyVector2.tmp.set(0.0F, -320.0F).rotate(this.angle)));
         }
